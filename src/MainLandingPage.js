...
import heroScreenshotImageSrc from "images/demo/23996.jpg";
...
export default ({
  features = null,
  primaryButtonUrl = "#BlogIndex",
  primaryButtonText = "Postagens recentes",
  secondaryButtonUrl = "#AtendimentoOnline",
  secondaryButtonText = "Atendimento Online",
  buttonRoundedCss = "",
  landingPages = components.landingPages,
  innerPages = components.innerPages,
  blocks = components.blocks,
  heading = "Ponto-G!",
  description = "Seu espaço para falar sobre sexualidade e intimidade!"
}) => {
  /*
  ...
  features = features || [
    "Lives toda a Semana!",
    "Postagens sobre sexualidade e intimidade",
    "Atendimento online"
  ]; 
      ...
      <Container tw="bg-gray-100 -mx-8 -mt-8 pt-8 px-8">
        <Content2Xl>
          ...
          <HeroRow>
            <UpdateNotice>
              <UpdateNoticeIcon />
                <NavLink target="_blank" href="https://youtube.com.br">
                  Não perca nossas lives! Sexta-feira às 19:00hs.
                </NavLink>
            </UpdateNotice>
            <TextColumn>
